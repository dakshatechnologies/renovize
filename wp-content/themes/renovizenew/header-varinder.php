		...
		<div id="rounded-nav-box" class="rounded">
			<div id="rounded-nav-box-overlay">
				...
				<form method="get" action="<?php echo trailingslashit( home_url() ); ?>">
					<div id="search-box" >
						<div class="search-box" style="margin:28px 0 0%">
							<label for="search-text">
								
								<?php do_action('va_search_for_above'); ?>
							</label>
							<input type="text" name="ls" id="search-text" class="search-box" style="height:32px;" value="<?php va_show_search_query_var( 'ls' ); ?>" />
									<button type="submit" id="" class="search-btn" style="padding:13px 39px;"><?php _e( 'Search', APP_TD ); ?></button>
						</div>
