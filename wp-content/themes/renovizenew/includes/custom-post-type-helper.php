...
function va_contact_post_author_button( $post_id = 0, $args = array() ) {
	...
	$elements .= html( 'label', array(), __( 'Name', APP_TD ), html( 'input', array( 'type'=>'text', 'id' => 'va-contact-name' ) ) );
	$elements .= html( 'label', array(), __( 'Email', APP_TD ), html( 'input', array( 'type'=>'text', 'id' => 'va-contact-email' ) ) );
	$elements .= html( 'label', array(), __( 'Phone Number', APP_TD ), html( 'input', array( 'type'=>'text', 'id' => 'va-contact-phone' ) ) );
	$elements .= html( 'label', array(), __( 'Website', APP_TD ), html( 'input', array( 'type'=>'text', 'id' => 'va-contact-website' ) ) );

	$elements .= html( 'label', array(), __( 'Message', APP_TD ), html( 'textarea', array( 'id' => 'va-contact-message' ) ) );
	...
	$box = html( 'div', array( 'id' => 'va-contact-form', 'class' => 'va-' . $post_type_obj->name . '-contact-form ' . $args['form_class'] ), $elements );
